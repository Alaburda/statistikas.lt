---
title: "Kaip sukurti boxplot su R? 4 būdai"
description: "Stačiakampė diagrama (boxplot) yra vienas populiariausių būdų vizualizuoti duomenų pasiskirstymą. Šiame straipsnyje parodysiu, kaip sukurti boxplot naudojant base R, ggplot2, tidyplots ir ggpubr paketus."
date: "2026-02-08"
...
[`tidyplots`](https://jbengler.github.io/tidyplots/) yra naujas paketas, sukurtas specialiai mokslinėms publikacijoms. Jo sintaksė yra labai intuityvi – naudojamas *pipe* operatorius `|>`, o funkcijos pradedamos nuo `add_`, `adjust_`, `remove_`:
...
[`ggpubr`](https://rpkgs.datanovia.com/ggpubr/) yra `ggplot2` plėtinys, kuris supaprastina grafikų kūrimą ir prideda galimybę tiesiogiai grafikuose rodyti statistinius palyginimus:
